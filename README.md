...
## Challenge Overview
For this challenge, in addition to calculating the winner from each of the candidates with their vote count and percentage, we were also tasked to calculate the performance of the three counties. Reading the CSV file with the data of the three counties and candidates, the python script calculated the additional requirements that were:
...
#### Deliverable 2
The third deliverable required us to output the result to a text file which had a directory pathway set in the beginning of the script. After importing the csv and os module, the following code was added to create a directory path to write to a text file and read a csv file:
...
A series of f statements were written whcih were then written to the text file:
...
This code run, results in the output text file as shown in the Challenge Overview section.

### Election Audit Summary
The scipt designed for this challenge can work for any type of election.
